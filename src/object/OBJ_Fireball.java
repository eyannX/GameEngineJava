...
public class OBJ_Fireball extends Projectile {
    ...
    public void getImage() {
        ...
        left1 = setup("/projectile/arrow/right", gp.tileSize,gp.tileSize);
        left2 = setup("/projectile/arrow/right", gp.tileSize,gp.tileSize);
        right1 = setup("/projectile/arrow/left", gp.tileSize,gp.tileSize);
        right2 = setup("/projectile/arrow/left", gp.tileSize,gp.tileSize);
    }
    @Override
